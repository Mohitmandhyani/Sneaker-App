...
class _ProductCardState extends State<ProductCard> {
    ...
    widget.productId,
    color: widget.product.colors?.isNotEmpty == true ? widget.product.colors![0] : "",
    size: widget.product.sizes?.isNotEmpty == true ? widget.product.sizes![0] : 0, // Default value of 0
  );
}
              ...
              child: Container(
                ...
                child: Hero(
                  ...
                  child: FadeInImage.assetNetwork(
                    ...
                    image: widget.product.images?.isNotEmpty == true ? widget.product.images![0] : "",
                  ),
                ),
              ),
            ),
